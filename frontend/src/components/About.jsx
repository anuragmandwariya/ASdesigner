...
// 1. IMPORT THE IMAGE
// Ensure the file 'about_image.png' is in 'src/assets'
import aboutImg from '../assets/about_image.png'; 

const About = () => {
  // Dynamic Year calculation for the experience badge (Optional but helpful)
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative group">
          ...
          <div className="absolute -bottom-6 -right-6 bg-white p-8 shadow-lg hidden md:block border-l-4 border-accent-gold">
            <p className="font-serif text-4xl text-stone-900">{experienceYears}+</p>
        ...
        <div>
          ...
          {/* Link update: Hash link works fine for single page apps on Render */}
